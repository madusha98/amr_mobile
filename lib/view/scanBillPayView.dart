            ...
            child: Column(
              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(left: PADDING,top: PADDING*1.2, right: PADDING),
                    child: Text(
                      'Amount (LKR)',
                      style: TextStyle(
                        fontSize: 16,
                ...
                Padding(
                  padding: const EdgeInsets.only(left: PADDING, top: 5.0, right: PADDING),
                  child: TextField(
                ...
                Column(
                    ...
                    children: [
                      ...
                      Align(
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: PADDING, top: PADDING*1.5, right: PADDING),
                            child: Container(
                              height: 55,
